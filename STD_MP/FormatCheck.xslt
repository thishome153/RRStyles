...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="Pack">
		...
		<xsl:choose>
			...
			<xsl:when test="$code = 'startO'">
				<xsl:value-of
					select="'Запрос в подразделение Росреестра'" />
			</xsl:when>
	...
	<xsl:template name="Doc">
		...
		<xsl:choose>
			...
			<xsl:when test="$code = 'Denial'">
				<xsl:value-of
					select="'Отправка пакета возможна ПРИ УСЛОВИИ...'" />
			</xsl:when>
			<xsl:when test="$code = 'ArchiveRequest'">
			...
			<xsl:when test="$code = 'TPLinear'">
				<xsl:value-of
					select="'Технический план линейного сооружения'" />
			</xsl:when>
			<xsl:when test="$code = 'TPLinearPart'">
				<xsl:value-of
					select="'Технический план условной части линейного сооружения'" />
			</xsl:when>
			<xsl:when test="$code = 'STD_KAIS'">
				<xsl:value-of
					select="'Заявление: Изменение характеристик объектов, версия 02'" />
			</xsl:when>
			<xsl:when test="$code = 'KAIS03'">
				<xsl:value-of
					select="'Заявление: Изменение характеристик объектов, версия 03'" />
			</xsl:when>
			<xsl:when test="$code = 'KAIS05'">
				<xsl:value-of
					select="'Заявление: Изменение характеристик объектов, версия 05'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'Cadastral_Cost_Dictionary'">
				<xsl:value-of
					select="'Удельные показатели кадастровой стоимости'" />
			</xsl:when>
			<xsl:when test="$code = 'SIGN'">
			...
			<xsl:when test="$code = 'ActForest'">
				<xsl:value-of
					select="'Акт о внесении сведений о ранее учтенных лесных участках'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'SchemeZUnaKPT'">
				<xsl:value-of
					select="'Схема расположения ЗУ на КПТ, версия 01'" />
			</xsl:when>
			<xsl:when test="$code = 'SchemeZUnaKPT2'">
				<xsl:value-of
					select="'Схема расположения ЗУ на КПТ, версия 02'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'MapPlan01'">
				<xsl:value-of
					select="'Карта-план территории, версия 01'" />
			</xsl:when>
			<xsl:when test="$code = 'ProjMZU'">
				<xsl:value-of
					select="'Проект межевания земельных участков'" />
			</xsl:when>
			<xsl:when test="$code = 'startO'">
				<xsl:value-of
					select="'Запрос в подразделение Росреестра'" />
			...
			<xsl:when test="$code = 'protocol[P]'">
				<xsl:value-of
					select="'Протокол контроля ОРП - положительный'" />
			</xsl:when>
			<xsl:when test="$code = 'protocol[N]'">
				<xsl:value-of
					select="'Протокол контроля ОРП - отрицательный'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'proto[N]'">
				<xsl:value-of
					select="'Протокол контроля - отрицательный'" />
			</xsl:when>
			<xsl:when test="$code = 'protoR[?]'">
				<xsl:value-of
					select="'Протокол контроля ПК Регистратор'" />
			</xsl:when>
			<xsl:when test="$code = 'protoR[P]'">
				<xsl:value-of
					select="'Протокол контроля ПК Регистратор - положительный'" />
			</xsl:when>
			<xsl:when test="$code = 'protoR[N]'">
				<xsl:value-of
					select="'Протокол контроля ПК Регистратор - отрицательный'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'protoP[P]'">
				<xsl:value-of
					select="'Протокол контроля портала - положительный'" />
			</xsl:when>
			<xsl:when test="$code = 'protoP[N]'">
				<xsl:value-of
					select="'Протокол контроля портала - отрицательный'" />
			</xsl:when>
			<xsl:when test="$code = 'protocolR[?]'">
				<xsl:value-of
					select="'Протокол загрузки заявления в АИС ГКН'" />
			</xsl:when>
			<xsl:when test="$code = 'protocolR[P]'">
				<xsl:value-of
					select="'Протокол загрузки заявления в АИС ГКН - положительный'" />
			</xsl:when>
			<xsl:when test="$code = 'protocolR[N]'">
				<xsl:value-of
					select="'Протокол загрузки заявления в АИС ГКН - отрицательный'" />
			</xsl:when>
			<xsl:when test="$code = 'protocolOKS[?]'">
				<xsl:value-of
					select="'Протокол загрузки технического паспорта в АИС ГКН'" />
			</xsl:when>
			<xsl:when test="$code = 'protocolOKS[P]'">
				<xsl:value-of
					select="'Протокол загрузки технического паспорта в АИС ГКН - положительный'" />
			</xsl:when>
			<xsl:when test="$code = 'protocolOKS[N]'">
				<xsl:value-of
					select="'Протокол загрузки технического паспорта в АИС ГКН - отрицательный'" />
			</xsl:when>
			<xsl:when test="$code = 'protocolMP[?]'">
				<xsl:value-of
					select="'Протокол загрузки межевого плана в АИС ГКН'" />
			</xsl:when>
			<xsl:when test="$code = 'protocolMP[P]'">
				<xsl:value-of
					select="'Протокол загрузки межевого плана в АИС ГКН - положительный'" />
			</xsl:when>
			<xsl:when test="$code = 'protocolMP[N]'">
				<xsl:value-of
					select="'Протокол загрузки межевого плана в АИС ГКН - отрицательный'" />
			</xsl:when>
			<xsl:when test="$code = 'protocol2[?]'">
				<xsl:value-of select="'Расписка'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'Scheme_Disposition_Parcels'">
				<xsl:value-of
					select="'Схема расположения земельных участков'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'Diagram_Parcels_SubParcels'">
				<xsl:value-of
					select="'Чертеж земельных участков и их частей'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'NodalPointSchemes'">
				<xsl:value-of
					select="'Абрис узловой точки границы земельного участка'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'Survey'">
				<xsl:value-of
					select="'Сведения об измерениях и расчетах'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'documF'">
				<xsl:value-of
					select="'Документ, удостоверяющий личность физ. лица'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'documFR'">
				<xsl:value-of
					select="'Документ, удостоверяющий личность правообладателя'" />
			</xsl:when>
			<xsl:when test="$code = 'documJR'">
				<xsl:value-of
					select="'Документ организации-правообладателя'" />
			</xsl:when>
			<xsl:when test="$code = 'documFD'">
				<xsl:value-of
					select="'Документ, удостоверяющий личность заявителя'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'documFA'">
				<xsl:value-of
					select="'Документ, удостоверяющий личность доверенного лица'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'documS'">
				<xsl:value-of
					select="'Документ, удостоверяющий сведения'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'planSub_Uncompleted_Construction'">
				<xsl:value-of
					select="'План части объекта незав.строит.'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'planF0'">
				<xsl:value-of
					select="'План помещения, не привязанного к этажу'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'planFB'">
				<xsl:value-of
					select="'План помещения в принадлежности-здании'" />
			</xsl:when>
			<xsl:when test="$code = 'planSB'">
				<xsl:value-of
					select="'План этажа в принадлежности-здании'" />
			</xsl:when>
			<xsl:when test="$code = 'planFC'">
				<xsl:value-of
					select="'План помещения в принадлежности-сооружении'" />
			</xsl:when>
			<xsl:when test="$code = 'planSC'">
				<xsl:value-of
					select="'План этажа в принадлежности-сооружении'" />
			</xsl:when>
			<xsl:when test="$code = 'planSC'">
				<xsl:value-of
					select="'План этажа в принадлежности-сооружении'" />
			...
			<xsl:when test="$code = 'in558207000000'">
				<xsl:value-of
					select="'Документ (копия) о согласовании местоположения границ ЗУ'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'in558209000000'">
				<xsl:value-of
					select="'Документ (копия) о разрешенном использованим земельного участка'" />
			</xsl:when>
			<xsl:when test="$code = 'in558401081200'">
				<xsl:value-of
					select="'Документ об ограничении вещных прав на объект в пользу заявителя'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'in558401070300'">
				<xsl:value-of
					select="'Декларация об объекте недвижимого имущества'" />
			</xsl:when>
			<xsl:when test="$code = 'in558214010000'">
				<xsl:value-of
					select="'Кадастровая выписка о земельном участке'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'out558213000000'">
				<xsl:value-of
					select="'Кадастровый паспорт объекта недвижимости'" />
			</xsl:when>
			<xsl:when test="$code = 'out558213010000'">
				<xsl:value-of
					select="'Кадастровый паспорт земельного участка'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'out558214000000'">
				<xsl:value-of
					select="'Кадастровая выписка об объекте недвижимости'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'out558220020000'">
				<xsl:value-of
					select="'Выписка из реестра, содержащая сведения об объекте учета'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'out558221020000'">
				<xsl:value-of
					select="'Иной документ, содержащий описание объекта недвижимости'" />
			</xsl:when>
			<xsl:when test="$code = 'out558501000000'">
				<xsl:value-of
					select="'Документы о результатах кадастрового учета'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'out558501010100'">
				<xsl:value-of
					select="'Решение об отказе в предоставлении запрашиваемых сведений'" />
			</xsl:when>
			<xsl:when test="$code = 'out558501010200'">
				<xsl:value-of
					select="'Решение об отказе в исправлении кадастровой ошибки.'" />
			</xsl:when>
			<xsl:when test="$code = 'out558501010300'">
				<xsl:value-of
					select="'Решение об отказе в исправлении технической ошибки'" />
			</xsl:when>
			<xsl:when test="$code = 'out558501010400'">
				<xsl:value-of
					select="'Решение об исправлении технической и кадастровой ошибки'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'out558501010600'">
				<xsl:value-of
					select="'Решение о приостановлении учета'" />
			</xsl:when>
			<xsl:when test="$code = 'out558501010700'">
				<xsl:value-of
					select="'Решение об отказе в снятии приостановления'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'out558501020200'">
				<xsl:value-of
					select="'Уведомление об осуществленном кадастровом учете'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'out558501020500'">
				<xsl:value-of
					select="'Уведомление об устранении технической ошибки в сведениях'" />
			</xsl:when>
			<xsl:when test="$code = 'out558501020600'">
				<xsl:value-of
					select="'УВЕДОМЛЕНИЕ об отказе в выдаче сведений об ОКС'" />
			</xsl:when>
			<xsl:when test="$code = 'out558501020700'">
				<xsl:value-of
					select="'Уведомление о приостановлении осуществления кадастрового учета'" />
			</xsl:when>
			<xsl:when test="$code = 'out558501020800'">
				<xsl:value-of
					select="'Уведомление об отказе в осуществлении кадастрового учета'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'out558501030100'">
				<xsl:value-of
					select="'Расписка в получении соответствующих документов для проведения ГКУ'" />
			</xsl:when>
			<xsl:when test="$code = 'out558501030200'">
				<xsl:value-of
					select="'Акт утверждения кадастровой стоимости'" />
			</xsl:when>
	...
	<xsl:template name="ControlStage">
		...
		<xsl:choose>
			...
			<xsl:when test="$code = 'Docum'">
				<xsl:value-of
					select="'Проверка корректности документа'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'OIDCheck'">
				<xsl:value-of
					select="'Контроль прав на доступ к виду регламента'" />
			</xsl:when>
			<xsl:when test="$code = 'AttachFile'">
				<xsl:value-of
					select="'Проверка наличия вложенных файлов'" />
			</xsl:when>
			<xsl:when test="$code = 'AttachNumber'">
				<xsl:value-of
					select="'Проверка количества вложенных файлов'" />
			</xsl:when>
			<xsl:when test="$code = 'FromTo'">
				<xsl:value-of
					select="'Проверка заполнения полей сообщения'" />
			</xsl:when>
			<xsl:when test="$code = 'Subject'">
				<xsl:value-of
					select="'Проверка корректности поля Subject'" />
			</xsl:when>
			...
			<xsl:when test="$code = 'requestL'">
				<xsl:value-of
					select="'Автоматическая загрузка заявления в АИС ГКН'" />
			</xsl:when>
			<xsl:when test="$code = 'requestO'">
				<xsl:value-of
					select="'Автоматическая загрузка технического паспорта в АИС ГКН'" />
			</xsl:when>
			<xsl:when test="$code = 'requestM'">
				<xsl:value-of
					select="'Автоматическая загрузка межевого плана в АИС ГКН'" />
			</xsl:when>
			...
			<xsl:when test="substring($code,1,3) = '010'">
				<xsl:value-of
					select="'Обработка в подразделении Росреестра'" />
			</xsl:when>
