<xsl:stylesheet version='1.0'
	...
	<xsl:template name="FormParcel">
		...
		<tr>
			<td align="center">
				<span style="font-weight:bold">
					<xsl:text>3. Общие сведения об образуемом земельном участке</xsl:text>
					<xsl:value-of select="@CadastralNumber" />
				</span>
				<tr>
					<td>
					...
					<td>
						<table style="WIDTH: 100%" border="1" cellspacing="0"
							...
							<tr>
								...
								<td>Адрес земельного участка или описание его местоположения</td>
								<td>
									<xsl:variable name="var0"
							...
							<tr>
								...
								<td>Вид разрешенного использования</td>
								<td>
	...
	<xsl:template name="Footer">
		<footer>
			<p>
				...
				Дата работ
				<xsl:value-of
					select="//MP/GeneralCadastralWorks//@DateCadastral" />
				<br />

				<xsl:value-of select="//MP/@GUID" />
				<br />

				MP V06 Stylesheet v1.0451
				<br />
